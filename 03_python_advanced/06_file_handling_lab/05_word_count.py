...
words_path = os.path.join("..", "06_file_handling_lab", "words.txt")
text_path = os.path.join("..", "06_file_handling_lab", "input.txt")
output_file_path = os.path.join("..", "06_file_handling_lab", "output.txt")
